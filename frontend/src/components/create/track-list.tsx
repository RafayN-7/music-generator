...
export function TrackList({tracks}: {tracks: Track[]} ) {
    ...
    const [trackToRename, SetTrackToRename] = useState<Track>
            ...
            <div className="space-y-2">
                {filteredTracks.length > 0 ? (filteredTracks.map((track) => {
                    ...
                    case "processing" : 
                        ...
                        default:
                            return (
                                <div key={track.id} className="hover:bg-muted/50 flex cursor-pointer items-center gap-4 rounded-lg p-3 transition-colors"
